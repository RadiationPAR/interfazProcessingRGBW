...
VCC       3V3
GND       GND
OUT       2           Salida-->Onda Cuadrada
S2        3           Selección del tipo de fotodiodo
S3        4           Selección del tipo de fotodiodo
OE        11          habilitación de salida (active low)
S1        12          Selección para salida de escalado de frecuencia
S0        13          Selección para salida de escalado de frecuencia
